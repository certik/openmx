...
#pragma omp parallel shared(ko,EDM,CDM,k,spin,C,FermiF,natn,FNAN,MP,Spe_Total_CNO,WhatSpecies,M2G,Matomnum) private(OMPID,Nthrds,Nprocs,MA_AN,GA_AN,wanA,tnoA,Anum,LB_AN,GB_AN,wanB,tnoB,Bnum,i,j,dum)
	  { 
...
#pragma omp parallel shared(ko,iDM,EDM,CDM,k,spin,C,FermiF,natn,FNAN,MP,Spe_Total_CNO,WhatSpecies,M2G,Matomnum) private(OMPID,Nthrds,Nprocs,MA_AN,GA_AN,wanA,tnoA,Anum,LB_AN,GB_AN,wanB,tnoB,Bnum,i,j,dum)
	{ 
  ...
  ****************************************************/
  ...
  for (spin=0; spin<=SpinP_switch; spin++){
    for (k=iemin; k<=iemax; k++){
      ...
      sAN = (atomnum/numprocs)*myid + 1;
      eAN = (atomnum/numprocs)*(myid+1);
...
#pragma omp parallel shared(S,SD,k,spin,C,natn,FNAN,MP,Spe_Total_CNO,WhatSpecies,sAN,eAN) private(OMPID,Nthrds,Nprocs,GA_AN,wanA,tnoA,Anum,i,LB_AN,GB_AN,wanB,tnoB,Bnum,j,dum)
	...
	for (GA_AN=sAN+OMPID; GA_AN<=eAN; GA_AN+=Nthrds){
	  ...
	  sAN0 = (atomnum/numprocs)*ID + 1;
	  eAN0 = (atomnum/numprocs)*(ID+1);
